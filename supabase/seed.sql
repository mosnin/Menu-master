...
INSERT INTO notifications (
  ...
  ('c7000000-0000-4000-8000-000000000001',
   ...
   'checklist_item', '40000000-0000-4000-8000-000000000004',
   'e0000000-0000-4000-8000-000000000001',
  ...
  ('c7000000-0000-4000-8000-000000000002',
   ...
   'approval', '60000000-0000-4000-8000-000000000001',
   'e0000000-0000-4000-8000-000000000001',
...
INSERT INTO orchestrator_action_executions (
  ...
  '{"health_score": 0.82, "policy_decision": {"disposition": "auto_execute", "policy_rule": "safe_active"}, "plan_context": {"plan_id": "b1000000-0000-4000-8000-000000000001", "subgoal_id": "b2000000-0000-4000-8000-000000000001"}}'::jsonb,
  true, NULL, 45, '[]'::jsonb,
...
(
  ...
  '{"recompute_completeness"}',
  NULL, NULL, NULL, NULL,
  NULL, '{"b2000000-0000-4000-8000-000000000020"}'
),
...
(
  ...
  NULL, NULL, NULL, NULL,
  NULL, '{"b2000000-0000-4000-8000-000000000021"}'
);
...
(
  ...
  '{"recompute_closing_readiness"}',
  NULL, '{"b2000000-0000-4000-8000-000000000031"}'
);
...
INSERT INTO orchestrator_plans (
  ...
  '["stage_change", "document_upload"]'::jsonb,
  1, 'b1000000-0000-4000-8000-000000000001',
  NULL,
